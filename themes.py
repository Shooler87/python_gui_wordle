...
SIZE_CHOOSER_BG_COLOR = 34, 50, 228
...
def setup_themes():
    ...
    with dpg.theme(tag="size_chooser_selected_theme"):
        with dpg.theme_component(dpg.mvButton):
            dpg.add_theme_color(dpg.mvThemeCol_Button, SIZE_CHOOSER_BG_COLOR)
            dpg.add_theme_color(dpg.mvThemeCol_ButtonHovered, SIZE_CHOOSER_BG_COLOR)
            dpg.add_theme_color(dpg.mvThemeCol_ButtonActive, SIZE_CHOOSER_BG_COLOR)
